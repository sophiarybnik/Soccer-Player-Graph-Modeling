...
print(f"[data] loaded {len(train_graphs)} train graphs")
val_graphs   = torch.load(graphs_dir / "val.pt")
print(f"[data] loaded {len(val_graphs)} val graphs")
...
print(f"[saved] training results → outputs/train_val_curves.png")